...
(function () {
  ...
  /* ── DEFAULTS ─────────────────────────────────────────────── */
  var DEF_TOURS = [
    { id:'t1', title:'Classic Kashmir Tour', cat:'kashmir', duration:'5N/6D', groupSize:'Families',
      badge:'badge-gold', badgeText:'Best Seller', order:1,
      image:'https://images.unsplash.com/photo-1591649462430-c88aeea56a4f?w=600&q=85',
      desc:'The complete Kashmir circuit — Srinagar, Gulmarg, Pahalgam and Sonamarg — curated by Excursion Dazzle Tour & Travel.',
    ...
    { id:'t2', title:'Honeymoon Kashmir Special', cat:'honeymoon', duration:'6N/7D', groupSize:'Couples',
      badge:'badge-green', badgeText:'Romantic', order:2,
      image:'https://images.unsplash.com/photo-1598091383021-15ddea10925d?w=600&q=85',
      desc:'A dreamy Kashmir honeymoon — houseboat stay, private shikara rides and candlelit dinners on Dal Lake.',
      includes:['Luxury Houseboat','All Meals','Couple Activities','Private Vehicle','Room Décor'],
    ...
    { id:'t3', title:'Srinagar City & Lakes Tour', cat:'kashmir', duration:'3N/4D', groupSize:'Any',
      badge:'badge-royal', badgeText:'Popular', order:3,
      image:'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=85',
      desc:'A short, immersive Srinagar break — Dal Lake, Mughal Gardens, the old city and local bazaars.',
      includes:['Hotel/Houseboat','Breakfast','AC Vehicle','Local Guide','Shikara Ride'],
      itinerary:['Arrival, Dal Lake shikara ride','Mughal Gardens & Shankaracharya Temple','Old city, shrines and local bazaars','Departure'] },
    { id:'t4', title:'Gulmarg & Pahalgam Adventure', cat:'adventure', duration:'4N/5D', groupSize:'4-12',
      badge:'badge-green', badgeText:'Adventure', order:4,
      image:'https://images.unsplash.com/photo-1692287731328-58f55e8950cd?w=600&q=85',
      desc:'Gondola rides, valley treks and riverside camping across Gulmarg and Pahalgam.',
      includes:['Hotel Stay','All Meals','Gondola Tickets','Trek Guide','Transport'],
      itinerary:['Arrival Srinagar, drive to Gulmarg','Gondola Phase 1 & 2, snow activities','Drive to Pahalgam, Betaab Valley','Aru & Chandanwari valleys','Return Srinagar, departure'] },
    { id:'t5', title:'Family Kashmir Package', cat:'family', duration:'7N/8D', groupSize:'Families',
      ...
      desc:'A kid-friendly family holiday covering every Kashmir highlight, at a relaxed pace.',
    ...
    { id:'t6', title:'Group Kashmir Tour', cat:'group', duration:'5N/6D', groupSize:'10-30',
      badge:'badge-gold', badgeText:'Group', order:6,
      image:'https://images.unsplash.com/photo-1593417376544-4c4201061e22?w=600&q=85',
      desc:'Fully managed group tours for large families, corporate retreats and school trips.',
  ...
  var DEF_CARS = [
    ...
    { id:'c4', name:'Tata Safari / Scorpio', sub:'SUV 4WD', featured:false, order:4,
      ...
      desc:'For rugged mountain roads and adventure-focused itineraries.' },
  ...
  var DEF_GAL = [
    { id:'g1', url:'https://images.unsplash.com/photo-1591649462430-c88aeea56a4f?w=800&q=85', caption:'Dal Lake, Srinagar', cat:'kashmir', order:1 },
    ...
    { id:'g3', url:'https://images.unsplash.com/photo-1692287731328-58f55e8950cd?w=800&q=85', caption:'Gulmarg Meadows', cat:'kashmir', order:3 },
    ...
    { id:'g5', url:'https://images.unsplash.com/photo-1623996732821-66f739df7280?w=800&q=85', caption:'Green Valley Kashmir', cat:'kashmir', order:5 },
    { id:'g6', url:'https://images.unsplash.com/photo-1542401886-65d6c61db217?w=800&q=85', caption:'Adventure Travel', cat:'adventure', order:6 },
    { id:'g7', url:'https://images.unsplash.com/photo-1593417376544-4c4201061e22?w=800&q=85', caption:'Pahalgam Riverside', cat:'kashmir', order:7 },
    { id:'g8', url:'https://images.unsplash.com/photo-1584732200355-486a95263014?w=800&q=85', caption:'Snow Peaks', cat:'adventure', order:8 }
  ];
